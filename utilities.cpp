...
void writeToFileHDF5(double *x, double *y, int *condition, const int NP, const int NI, int L, double dt, int step){
  ...
  dataset3.write(condition, PredType::NATIVE_INT);
